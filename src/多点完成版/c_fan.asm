#include <head.inc>
//延时表：DELAY2US，DELAY10US，DELAY60US，DELAY80US，DELAY600US，DELAY10MS，DELAY100MS
ORG 0000H     							//复位地址
AJMP MAIN     							//绝对短跳转至主程序
ORG 0003H	  							//外中断0入口地址
...
ACALL RS_18B20_1							//18B20初始化
MOV A, #0CCH							//跳过ROM(ROM指令)
ACALL W_18B20_BYTE_1
MOV A, #4EH								//写暂存器(功能指令)
ACALL W_18B20_BYTE_1
MOV A, #55H								//高温报警限
ACALL W_18B20_BYTE_1
...
ACALL DELAY60US
SETB DQ1
DJNZ R5, W_18B20_BIT_1
RET
R_18B20_BYTE_1:	/*读18B20一个字节*/		
SETB DQ1
MOV R5, #08H
R_18B20_BIT_1:
CLR DQ1
